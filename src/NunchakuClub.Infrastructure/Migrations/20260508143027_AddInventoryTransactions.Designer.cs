...
namespace NunchakuClub.Infrastructure.Migrations
{
    ...
    [Migration("20260508143027_AddInventoryTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.BranchInventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("ExportedThisMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("exported_this_month");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_branch_inventories");

                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_branch_inventories_branch_id");

                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_branch_inventories_item_id");

                    b.HasIndex("BranchId", "ItemId")
                        .IsUnique()
                        .HasDatabaseName("ix_branch_inventories_branch_id_item_id");

                    b.ToTable("branch_inventories", (string)null);
                });

            modelBuilder.Entity("NunchakuClub.Domain.Entities.BranchStats", b =>
                {
                    ...
                    b.Property<List<Guid>>("AssistantCoachIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("assistant_coach_ids");
                    ...
                    b.Property<List<Guid>>("HeadCoachIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("head_coach_ids");
                    ...
                    b.ToView("v_branch_stats", (string)null);
                });
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.InventoryCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BranchInventoryId")
                        .HasDatabaseName("ix_inventory_transactions_branch_inventory_id");
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.BranchInventory", b =>
                {
                    b.HasOne("NunchakuClub.Domain.Entities.Branch", "Branch")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_branch_inventories_branches_branch_id");

                    b.HasOne("NunchakuClub.Domain.Entities.InventoryItem", "Item")
                        .WithMany("BranchInventories")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_branch_inventories_inventory_items_item_id");
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.InventoryItem", b =>
                {
                    b.HasOne("NunchakuClub.Domain.Entities.InventoryCategory", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("NunchakuClub.Domain.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("NunchakuClub.Domain.Entities.BranchInventory", "BranchInventory")
                        .WithMany()
                        .HasForeignKey("BranchInventoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_transactions_branch_inventories_branch_inventory_");
